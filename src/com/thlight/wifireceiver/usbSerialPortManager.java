...
public class usbSerialPortManager {
	...
	private final String ACTION_USB_PERMISSION = "com.thlight.light_cup_receiver.USB_PERMISSION";
...
//	UsbEndpoint Endpoint_in_2  	= null;
	...
	public void SerialSettingInitial(int index)
	{
		mUsbConnections[index].controlTransfer(0x40, 0, 0, 0, null, 0, 25);// reset
 		...
 		if(THLApp.apManager.isNetworkConnected())
 			startScan(index);
	}
	/** ================================================ */
...
//			tv.setText(msg);
            ...
            mHandler.removeMessages(Constants.MSG_STATR_UPLOAD_TASK);
	    			
    	    mHandler.sendEmptyMessageDelayed(Constants.MSG_RECEIVE,10);
			mHandler.sendEmptyMessageDelayed(Constants.MSG_STATR_UPLOAD_TASK, Integer.valueOf(THLApp.upload_time));
    ...
    {
    	String HexTime = Integer.toHexString(Integer.valueOf(THLApp.scan_time));
		String StopHexTime = Integer.toHexString(Integer.valueOf(THLApp.stop_scan_time));
		String OutputStirng = "";
		if(HexTime.length() == 4)    				
