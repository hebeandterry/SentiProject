...
public class Constants {
	public static final int MSG_RECEIVE = 1001;
	...
	public static final int MSG_CHANGE_AP_WIFI  = 1007;
	public static final int MSG_DELETE_AW_FILE  = 1008;
	public static final int MSG_STATR_UPLOAD_TASK = 1009;
	...
	public static final int TCPIP_START_WIFI_MODE 			= 2007;
	public static final int TCPIP_SET_ALL_DATA	 			= 2008;
	public static final int TCPIP_ACK_ALL_DATA	 			= 3000;
